...
ggplot() +
  ...
  theme_void() +
  labs(title = "Ethiopian Water Sources (1998-2020)") +
  ...
  theme(legend.position = "none",
        ...
        plot.title = element_text(face = "bold", color = "#E7AA7B", size = 20, hjust = 0.5,
                                  margin=margin(15,0,30,0)),
        strip.text = element_text(margin = margin(0,0,8,0),
                                  colour = '#E7AA7B', face = "bold", size = 12, family = "Helvetica"))
